"""
DictaFlow — Pill UI flotante
Base: sflow (Joel Tabasco) — barras animadas, draggable
"""
import math
import logging
...
from config import PILL_WIDTH, PILL_HEIGHT
...
BORDER = {
    "idle":       QColor(130, 80, 255),
    "recording":  QColor(255, 60, 60),
...
class PillUI(QWidget):
    ...
    def paintEvent(self, event):
        ...
        if self._state == PillState.IDLE:
            ...
            painter.drawText(rect, Qt.AlignmentFlag.AlignCenter, "🎙  DictaFlow")
        elif self._state == PillState.RECORDING:
